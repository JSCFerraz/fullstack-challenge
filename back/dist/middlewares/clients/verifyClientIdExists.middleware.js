...
const verifyClientIdExistsMiddleware = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!findClient) {
        throw new app_errors_1.default("Client not fount", 404);
    }
    return next();
});
exports.default = verifyClientIdExistsMiddleware;
