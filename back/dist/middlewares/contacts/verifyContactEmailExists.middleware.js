...
const verifyContactEmailExistsMiddleware = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (req.body.email) {
        ...
        if (findContactEmail) {
            if (findContactEmail.id !== req.params.id) {
                throw new app_errors_1.default("Contact email already exists.", 409);
            }
        }
    }
    return next();
});
exports.default = verifyContactEmailExistsMiddleware;
